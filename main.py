...
def tools():
    clear()
    stdout.write("                                                                                         \n")
    stdout.write("                                 "+Fore.LIGHTCYAN_EX    +" Kageno Tools             \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"╔═════════════════════════════════════════════════════╗\n")
...
##############################################################################################
def command():
    stdout.write(Fore.LIGHTCYAN_EX+"[""System"+Fore.LIGHTRED_EX+"@"+Fore.LIGHTBLACK_EX+"Kageno"+Fore.LIGHTCYAN_EX+"]"+Fore.WHITE)
    command = input()
